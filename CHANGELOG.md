...
### Corregido
- **Las gráficas de los resultados ya no necesitan internet.** La página de resultados se descargaba la librería de gráficas desde internet cada vez que se abría: era **el único punto de todo PitWall** que dependía de tener línea, y en un circuito no siempre la hay — sin conexión, las gráficas sencillamente no salían. Ahora esa librería la sirve el propio PitWall, igual que ya hacía la vista de estadísticas en vivo.
